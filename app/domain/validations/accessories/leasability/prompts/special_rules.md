...
- Leasable: bike-mounted smartphone holder, handlebar smartphone holder, frame-mounted smartphone holder, fixed smartphone holder system
- Not leasable: smartphone, loose phone case, loose phone bag, loose phone adapter, counterpart clearly sold alone and not usable as a bike-mounted holder by itself
- Can not be determined: phone case, plate, bag, adapter, or counterpart where the matching bike-mounted holder is not confirmed; unclear whether the item is the holder itself or only a counterpart

4. Adapters and holder systems
- Leasable: fixed bike adapter, bike-mounted adapter, adapter system fixed to the bike, holder system fixed to the bike
- Not leasable: loose adapter, general-purpose adapter, adapter mounted only on another accessory, adapter that requires another accessory to work and is sold alone
- Can not be determined: adapter with unknown mounting method, holder system where it is unclear whether it is bike-mounted

5. Cargo bike accessories
- Leasable: cargo bike body, cargo bike box, cargo bike crate, child seat for cargo bike, seat cushion for cargo bike, dog cushion for cargo bike, floor mat for cargo bike, box cover, tarpaulin, child canopy, cargo bike transport module, cargo/passenger safety component, animal transport safety component
- Not leasable: general-purpose basket, general-purpose dog basket, general-purpose bag, accessory not specifically tied to a cargo bike
...
- Do not confuse cargo-bike-specific with bike-mounted. A cargo-bike accessory can be loose/removable and still match this special rule.
